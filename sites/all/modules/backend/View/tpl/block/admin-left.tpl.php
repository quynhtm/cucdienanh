...
<div class="navigation">
	<ul>
        ...
        <li <?php if($param[1]=='news' || $param[1]=='video' || $param[1]=='category'){?> class="active" <?php } ?>>
            <a title="" href="javascript:void(0)"><i class="icon-cogs"></i> Quản lý nội dung<i class="icon-arrow"></i></a>
            <ul class="sub">
                <li <?php if($param[1]=='category'){?> class="active" <?php } ?>><a class="" title="" href="<?php echo $base_url ?>/admincp/category"><i class="icon-minus"></i> Danh mục tin tức</a></li>
